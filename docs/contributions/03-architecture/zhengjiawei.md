...
- [ ] architecture.md（全部）
- [x] architecture.md（第 2 节：后端架构设计）
- [x] architecture.md（第 3 节：数据库设计）
- [x] backend.md — 后端技术文档（技术栈、目录结构、数据库设计、实体类、DTO/VO、API 接口、依赖配置、业务逻辑说明）
- [x] docs/api.md — API 接口文档（用户、团队、团队成员、加入请求、邀请、通知 共 6 大模块 27 个接口）
- [x] docs/database.md — 数据库 ER 图（mermaid 格式）
- [x] docs/design-spec.md — 设计说明（配色方案、字体规范、核心页面、交互说明）
- [x] 其他文档（README.md 中的团队分工、功能需求等）
