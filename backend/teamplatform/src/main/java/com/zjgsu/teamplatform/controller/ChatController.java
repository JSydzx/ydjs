...
public class ChatController {
     ...
     */
    @GetMapping("/list")
    public Result<List<ChatConversationVO>> list(@RequestAttribute(Constants.CURRENT_USER_ID) Long userId) {
    ...
    public Result<List<ChatMessageVO>> messages(@RequestAttribute(Constants.CURRENT_USER_ID) Long userId,
     ...
     */
    @PostMapping("/send")
    public Result<ChatMessageVO> send(@RequestAttribute(Constants.CURRENT_USER_ID) Long userId,
