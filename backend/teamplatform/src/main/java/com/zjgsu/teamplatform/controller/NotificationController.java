...
public class NotificationController {
     ...
     */
    @GetMapping("/list")
    public Result<List<Notification>> list(@RequestAttribute(Constants.CURRENT_USER_ID) Long userId) {
     ...
     */
    @PostMapping("/{id}/read")
    public Result<Void> read(@RequestAttribute(Constants.CURRENT_USER_ID) Long userId,
